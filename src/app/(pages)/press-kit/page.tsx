...
export default function PressKit() {
	...
	return <div className={styles.main_content}>
		<p>
			Please do not modify any of these logos. They should also not be used to represent you or your projects, products, or company.
		</p>
		<div className={styles.logos}>
			<Logo svgLink={`${basePath}img/wjtb.svg`}
				pngLink={`${basePath}img/wjtb.png`}
				name="Logo (Dark)"
				theme="dark" />
			<Logo svgLink={`${basePath}img/wjtb_light.svg`}
				pngLink={`${basePath}img/wjtb_light.png`}
				name="Logo (Light)"
				theme="paper" />
			<Logo svgLink={`${basePath}img/wjtb_red.svg`}
				pngLink={`${basePath}img/wjtb_red.png`}
				name="Logo (NJIT Red)"
				theme="dark" />
			<Logo svgLink={`${basePath}img/wjtb_radio.svg`}
				pngLink={`${basePath}img/wjtb_radio.png`}
				name="Radio Logo (Dark)"
				theme="dark" />
			<Logo svgLink={`${basePath}img/wjtb_radio_light.svg`}
				pngLink={`${basePath}img/wjtb_radio_light.png`}
				name="Radio Logo (Light)"
				theme="paper" />
			<Logo svgLink={`${basePath}img/wjtb_radio_red.svg`}
